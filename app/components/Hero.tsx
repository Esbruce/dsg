...
export default function Hero() {
  return (
    <div className="text-center py-8">
      <h1 className="text-4xl font-bold bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-dark)] bg-clip-text text-transparent mb-8">
        Medical Notes to Discharge Plan in seconds
      </h1>
